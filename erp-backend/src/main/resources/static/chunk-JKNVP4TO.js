...
// src/app/modules/sales/components/payments/sales-payment-list.component.ts
var _forTrack0 = ($index, $item) => $item.value;
var _forTrack1 = ($index, $item) => $item.id;
function SalesPaymentListComponent_For_51_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 33);
    \u0275\u0275listener("click", function SalesPaymentListComponent_For_51_Template_button_click_0_listener() {
...
function SalesPaymentListComponent_Conditional_69_Template(rf, ctx) {
  if (rf & 1) {
...
function SalesPaymentListComponent_Conditional_70_Template(rf, ctx) {
  if (rf & 1) {
...
function SalesPaymentListComponent_Conditional_71_For_19_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span", 48);
    \u0275\u0275listener("click", function SalesPaymentListComponent_Conditional_71_For_19_Conditional_9_Template_span_click_0_listener($event) {
      \u0275\u0275restoreView(_r6);
...
function SalesPaymentListComponent_Conditional_71_For_19_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
...
function SalesPaymentListComponent_Conditional_71_For_19_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr", 39);
    \u0275\u0275listener("click", function SalesPaymentListComponent_Conditional_71_For_19_Template_tr_click_0_listener() {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "td");
    \u0275\u0275conditionalCreate(9, SalesPaymentListComponent_Conditional_71_For_19_Conditional_9_Template, 4, 1, "span", 43)(10, SalesPaymentListComponent_Conditional_71_For_19_Conditional_10_Template, 2, 0, "span", 44);
    \u0275\u0275elementEnd();
...
function SalesPaymentListComponent_Conditional_71_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(18, SalesPaymentListComponent_Conditional_71_For_19_Template, 19, 19, "tr", 36, _forTrack1);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "tfoot")(21, "tr")(22, "td", 37);
    \u0275\u0275text(23, "TOTAL ENCAISS\xC9");
    \u0275\u0275elementEnd();
...
function SalesPaymentListComponent_Conditional_72_Conditional_37_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 48);
    \u0275\u0275listener("click", function SalesPaymentListComponent_Conditional_72_Conditional_37_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r2 = \u0275\u0275nextContext(2);
      ctx_r2.closeDetail();
...
function SalesPaymentListComponent_Conditional_72_Conditional_38_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " \u2014 ");
  }
}
function SalesPaymentListComponent_Conditional_72_Conditional_60_Template(rf, ctx) {
  if (rf & 1) {
...
function SalesPaymentListComponent_Conditional_72_Conditional_64_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 69);
    \u0275\u0275listener("click", function SalesPaymentListComponent_Conditional_72_Conditional_64_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext(2);
...
function SalesPaymentListComponent_Conditional_72_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 49);
    \u0275\u0275listener("click", function SalesPaymentListComponent_Conditional_72_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeDetail());
    });
    \u0275\u0275elementStart(1, "div", 50);
    \u0275\u0275listener("click", function SalesPaymentListComponent_Conditional_72_Template_div_click_1_listener($event) {
    ...
    \u0275\u0275listener("click", function SalesPaymentListComponent_Conditional_72_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeDetail());
    });
    ...
    \u0275\u0275conditionalCreate(37, SalesPaymentListComponent_Conditional_72_Conditional_37_Template, 4, 1, "a", 43)(38, SalesPaymentListComponent_Conditional_72_Conditional_38_Template, 1, 0);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(39, "div", 56)(40, "span", 57);
    \u0275\u0275text(41, "\xC9criture comptable");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "span", 61);
    \u0275\u0275text(43);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(44, "div", 56)(45, "span", 57);
    \u0275\u0275text(46, "M\xE9mo");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(47, "span", 62);
    \u0275\u0275text(48);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(49, "div", 63)(50, "span", 57);
    \u0275\u0275text(51, "Montant");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(52, "span", 64);
    \u0275\u0275text(53);
    \u0275\u0275pipe(54, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(55, "div", 56)(56, "span", 57);
    \u0275\u0275text(57, "Statut");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(58, "span", 46);
    \u0275\u0275text(59);
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(60, SalesPaymentListComponent_Conditional_72_Conditional_60_Template, 4, 1, "div", 65);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(61, "div", 66)(62, "button", 67);
    \u0275\u0275listener("click", function SalesPaymentListComponent_Conditional_72_Template_button_click_62_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeDetail());
    });
    \u0275\u0275text(63, "Fermer");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(64, SalesPaymentListComponent_Conditional_72_Conditional_64_Template, 4, 5, "button", 68);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(22, 13, ctx_r2.selectedPayment.date, "dd/MM/yyyy"));
    \u0275\u0275advance(6);
    ...
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(ctx_r2.selectedPayment.accountMoveName || "\u2014");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r2.selectedPayment.memo || "\u2014");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind2(54, 16, ctx_r2.selectedPayment.amount, "1.0-0"), " FCFA");
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.reverseError ? 60 : -1);
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx_r2.selectedPayment.state !== "reversed" ? 64 : -1);
  }
}
function SalesPaymentListComponent_Conditional_73_Conditional_29_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 75)(1, "span", 34);
    \u0275\u0275text(2, "refresh");
    \u0275\u0275elementEnd();
...
function SalesPaymentListComponent_Conditional_73_Conditional_29_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 76)(1, "span", 4);
...
function SalesPaymentListComponent_Conditional_73_Conditional_29_Conditional_2_For_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 80);
    \u0275\u0275listener("click", function SalesPaymentListComponent_Conditional_73_Conditional_29_Conditional_2_For_4_Template_div_click_0_listener() {
      const c_r12 = \u0275\u0275restoreView(_r11).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r2.selectClient(c_r12.id));
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(c_r12.name[0]);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(c_r12.name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", c_r12.invoiceCount, " facture(s) impay\xE9e(s)");
  }
}
function SalesPaymentListComponent_Conditional_73_Conditional_29_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 77);
    \u0275\u0275text(1, "S\xE9lectionnez le client \xE0 encaisser :");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "div", 78);
    \u0275\u0275repeaterCreate(3, SalesPaymentListComponent_Conditional_73_Conditional_29_Conditional_2_For_4_Template, 10, 3, "div", 79, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r2.unpaidClients);
  }
}
function SalesPaymentListComponent_Conditional_73_Conditional_29_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, SalesPaymentListComponent_Conditional_73_Conditional_29_Conditional_0_Template, 4, 0, "div", 75)(1, SalesPaymentListComponent_Conditional_73_Conditional_29_Conditional_1_Template, 5, 0, "div", 76)(2, SalesPaymentListComponent_Conditional_73_Conditional_29_Conditional_2_Template, 5, 0);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275conditional(ctx_r2.loadingInvoices ? 0 : ctx_r2.unpaidClients.length === 0 ? 1 : 2);
  }
}
function SalesPaymentListComponent_Conditional_73_Conditional_30_For_11_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 91);
    \u0275\u0275listener("click", function SalesPaymentListComponent_Conditional_73_Conditional_30_For_11_Template_div_click_0_listener() {
...
function SalesPaymentListComponent_Conditional_73_Conditional_30_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 86)(1, "button", 87);
    \u0275\u0275listener("click", function SalesPaymentListComponent_Conditional_73_Conditional_30_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275repeaterCreate(10, SalesPaymentListComponent_Conditional_73_Conditional_30_For_11_Template, 17, 13, "div", 90, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(ctx_r2.clientName(ctx_r2.selectedClientId));
    \u0275\u0275advance(4);
    \u0275\u0275repeater(ctx_r2.invoicesForClient);
  }
}
function SalesPaymentListComponent_Conditional_73_Conditional_31_For_44_Template(rf, ctx) {
  if (rf & 1) {
...
function SalesPaymentListComponent_Conditional_73_Conditional_31_Conditional_49_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 65)(1, "span", 4);
    \u0275\u0275text(2, "error_outline");
    \u0275\u0275elementEnd();
...
function SalesPaymentListComponent_Conditional_73_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
    const _r16 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 86)(1, "button", 87);
    \u0275\u0275listener("click", function SalesPaymentListComponent_Conditional_73_Conditional_31_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r16);
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275text(4, " Retour ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 97)(6, "div", 98)(7, "span");
    \u0275\u0275text(8, "Client");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "strong");
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 98)(12, "span");
    \u0275\u0275text(13, "Facture");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "strong");
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div", 98)(17, "span");
    \u0275\u0275text(18, "Reste \xE0 encaisser");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "strong", 99);
    \u0275\u0275text(20);
    \u0275\u0275pipe(21, "number");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(22, "div", 100)(23, "div", 101)(24, "label");
    \u0275\u0275text(25, "Date du paiement ");
    \u0275\u0275elementStart(26, "span", 102);
    \u0275\u0275text(27, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "input", 103);
    \u0275\u0275twoWayListener("ngModelChange", function SalesPaymentListComponent_Conditional_73_Conditional_31_Template_input_ngModelChange_28_listener($event) {
      \u0275\u0275restoreView(_r16);
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(29, "div", 101)(30, "label");
    \u0275\u0275text(31, "Montant (FCFA) ");
    \u0275\u0275elementStart(32, "span", 102);
    \u0275\u0275text(33, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(34, "input", 104);
    \u0275\u0275twoWayListener("ngModelChange", function SalesPaymentListComponent_Conditional_73_Conditional_31_Template_input_ngModelChange_34_listener($event) {
      \u0275\u0275restoreView(_r16);
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(35, "div", 101)(36, "label");
    \u0275\u0275text(37, "Journal ");
    \u0275\u0275elementStart(38, "span", 102);
    \u0275\u0275text(39, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(40, "select", 105);
    \u0275\u0275twoWayListener("ngModelChange", function SalesPaymentListComponent_Conditional_73_Conditional_31_Template_select_ngModelChange_40_listener($event) {
      \u0275\u0275restoreView(_r16);
      const ctx_r2 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r2.payForm.journalId, $event) || (ctx_r2.payForm.journalId = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(41, "option", 106);
    \u0275\u0275text(42, "-- Choisir --");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(43, SalesPaymentListComponent_Conditional_73_Conditional_31_For_44_Template, 2, 2, "option", 107, _forTrack1);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(45, "div", 101)(46, "label");
    \u0275\u0275text(47, "M\xE9mo");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(48, "input", 108);
    \u0275\u0275twoWayListener("ngModelChange", function SalesPaymentListComponent_Conditional_73_Conditional_31_Template_input_ngModelChange_48_listener($event) {
      \u0275\u0275restoreView(_r16);
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(49, SalesPaymentListComponent_Conditional_73_Conditional_31_Conditional_49_Template, 4, 1, "div", 65);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(10);
...
function SalesPaymentListComponent_Conditional_73_Conditional_32_Template(rf, ctx) {
  if (rf & 1) {
    const _r18 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 66)(1, "button", 67);
    \u0275\u0275listener("click", function SalesPaymentListComponent_Conditional_73_Conditional_32_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r18);
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function SalesPaymentListComponent_Conditional_73_Conditional_32_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r18);
      const ctx_r2 = \u0275\u0275nextContext(2);
...
function SalesPaymentListComponent_Conditional_73_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 49);
    \u0275\u0275listener("click", function SalesPaymentListComponent_Conditional_73_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeNewPayment());
    });
    \u0275\u0275elementStart(1, "div", 70);
    \u0275\u0275listener("click", function SalesPaymentListComponent_Conditional_73_Template_div_click_1_listener($event) {
      return $event.stopPropagation();
    });
    \u0275\u0275elementStart(2, "div", 51)(3, "div", 52)(4, "span", 4);
    \u0275\u0275text(5, "add_circle");
    \u0275\u0275elementEnd();
    \u0275\u0275text(6, " Nouveau paiement client");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "button", 53);
    \u0275\u0275listener("click", function SalesPaymentListComponent_Conditional_73_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeNewPayment());
    });
    ...
    \u0275\u0275text(9, "close");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(10, "div", 71)(11, "div", 72)(12, "div", 73);
    \u0275\u0275text(13, "1");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275element(22, "div", 74);
    \u0275\u0275elementStart(23, "div", 72)(24, "div", 73);
    \u0275\u0275text(25, "3");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275conditionalCreate(29, SalesPaymentListComponent_Conditional_73_Conditional_29_Template, 3, 1);
    \u0275\u0275conditionalCreate(30, SalesPaymentListComponent_Conditional_73_Conditional_30_Template, 12, 1);
    \u0275\u0275conditionalCreate(31, SalesPaymentListComponent_Conditional_73_Conditional_31_Template, 50, 12);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(32, SalesPaymentListComponent_Conditional_73_Conditional_32_Template, 7, 5, "div", 66);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
var SalesPaymentListComponent = class _SalesPaymentListComponent {
  constructor(salesService, auth, http, router) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SalesPaymentListComponent, selectors: [["app-sales-payment-list"]], decls: 74, vars: 16, consts: [[1, "page-container"], [1, "page-header"], [1, "header-left"], [1, "page-title"], [1, "material-icons"], [1, "record-count"], [1, "header-right"], [1, "btn-new", 3, "click"], [1, "btn-refresh", 3, "click", "disabled"], [1, "stats-grid"], [1, "stat-card"], [1, "stat-icon", "stat-blue"], [1, "stat-body"], [1, "stat-label"], [1, "stat-value"], [1, "stat-icon", "stat-green"], [1, "stat-currency"], [1, "stat-icon", "stat-red"], [1, "filter-bar"], [1, "filter-chips"], [1, "filter-chip", 3, "active"], [1, "filter-right"], [1, "date-range"], [1, "material-icons", "date-icon"], ["type", "date", 1, "form-input", 3, "ngModelChange", "ngModel"], [1, "date-sep"], [1, "search-box"], ["type", "text", "placeholder", "Client, facture\u2026", 3, "ngModelChange", "ngModel"], [1, "btn-clear", 3, "click"], [1, "card"], [1, "empty-state"], [1, "data-table"], [1, "modal-overlay"], [1, "filter-chip", 3, "click"], [1, "material-icons", "spin"], [1, "text-right"], [1, "clickable-row", 3, "row-reversed"], ["colspan", "6", 1, "foot-label"], [1, "foot-value"], [1, "clickable-row", 3, "click"], [1, "font-mono", "font-bold"], [1, "nowrap"], [1, "font-bold"], [1, "link-invoice"], [1, "text-muted"], [1, "small", "text-muted"], [1, "badge"], [1, "text-right", "font-mono"], [1, "link-invoice", 3, "click"], [1, "modal-overlay", 3, "click"], [1, "modal-panel", 3, "click"], [1, "modal-hdr"], [1, "modal-title"], [1, "modal-close", 3, "click"], [1, "modal-body"], [1, "detail-grid"], [1, "detail-item"], [1, "detail-label"], [1, "detail-value", "font-mono", "font-bold"], [1, "detail-value"], [1, "detail-value", "font-bold"], [1, "detail-value", "font-mono"], [1, "detail-value", "text-muted"], [1, "detail-item", "detail-item-full"], [1, "detail-value", "amount-big"], [1, "alert-error"], [1, "modal-ftr"], [1, "btn-secondary-modal", 3, "click"], [1, "btn-danger-modal", 3, "disabled"], [1, "btn-danger-modal", 3, "click", "disabled"], [1, "modal-panel", "modal-panel-lg", 3, "click"], [1, "steps-bar"], [1, "step"], [1, "step-dot"], [1, "step-line"], [1, "step-loading"], [1, "step-empty"], [1, "step-hint"], [1, "supplier-grid"], [1, "supplier-card"], [1, "supplier-card", 3, "click"], [1, "supplier-avatar"], [1, "supplier-info"], [1, "supplier-name"], [1, "supplier-count"], [1, "material-icons", "supplier-arrow"], [1, "step-back"], [1, "btn-back-step", 3, "click"], [1, "step-context"], [1, "invoice-list-select"], [1, "invoice-select-card"], [1, "invoice-select-card", 3, "click"], [1, "inv-ref", "font-mono", "font-bold"], [1, "inv-date", "text-muted", "small"], [1, "inv-amounts"], [1, "inv-total"], [1, "inv-due"], [1, "inv-recap"], [1, "inv-recap-row"], [1, "text-danger"], [1, "pay-form-grid"], [1, "form-group"], [1, "req"], ["type", "date", 1, "form-control", 3, "ngModelChange", "ngModel"], ["type", "number", "min", "0.01", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "form-control", 3, "ngModelChange", "ngModel"], ["disabled", "", 3, "ngValue"], [3, "ngValue"], ["type", "text", "placeholder", "Optionnel", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "btn-primary-modal", 3, "click", "disabled"]], template: function SalesPaymentListComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275listener("click", function SalesPaymentListComponent_Template_button_click_14_listener() {
          return ctx.load();
        });
        ...
        \u0275\u0275repeaterCreate(50, SalesPaymentListComponent_For_51_Template, 2, 3, "button", 20, _forTrack0);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(52, "div", 21)(53, "div", 22)(54, "span", 23);
        \u0275\u0275text(55, "date_range");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(56, "input", 24);
        \u0275\u0275twoWayListener("ngModelChange", function SalesPaymentListComponent_Template_input_ngModelChange_56_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.dateFrom, $event) || (ctx.dateFrom = $event);
          return $event;
        });
        \u0275\u0275listener("ngModelChange", function SalesPaymentListComponent_Template_input_ngModelChange_56_listener() {
        ...
        \u0275\u0275twoWayListener("ngModelChange", function SalesPaymentListComponent_Template_input_ngModelChange_59_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.dateTo, $event) || (ctx.dateTo = $event);
          return $event;
        });
        \u0275\u0275listener("ngModelChange", function SalesPaymentListComponent_Template_input_ngModelChange_59_listener() {
          return ctx.applyFilter();
        });
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275twoWayListener("ngModelChange", function SalesPaymentListComponent_Template_input_ngModelChange_63_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.searchClient, $event) || (ctx.searchClient = $event);
          return $event;
        });
        \u0275\u0275listener("ngModelChange", function SalesPaymentListComponent_Template_input_ngModelChange_63_listener() {
          return ctx.applyFilter();
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(64, "button", 28);
        \u0275\u0275listener("click", function SalesPaymentListComponent_Template_button_click_64_listener() {
        ...
        \u0275\u0275conditionalCreate(69, SalesPaymentListComponent_Conditional_69_Template, 5, 0, "div", 30)(70, SalesPaymentListComponent_Conditional_70_Template, 5, 0, "div", 30)(71, SalesPaymentListComponent_Conditional_71_Template, 27, 4, "table", 31);
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(72, SalesPaymentListComponent_Conditional_72_Template, 65, 19, "div", 32);
        \u0275\u0275conditionalCreate(73, SalesPaymentListComponent_Conditional_73_Template, 33, 14, "div", 32);
      }
      if (rf & 2) {
        \u0275\u0275advance(8);
        ...
        \u0275\u0275advance(4);
        \u0275\u0275twoWayProperty("ngModel", ctx.searchClient);
        \u0275\u0275advance(6);
...
(() => {
  ...
  <div class="stats-grid">
    ...
    <div class="stat-card">
      ...
      <div class="stat-body">
        <div class="stat-label">Total encaiss\xE9</div>
  ...
  <div class="filter-bar">
    ...
    <div class="filter-right">
      ...
      <div class="search-box">
        ...
        <input type="text" placeholder="Client, facture\u2026" [(ngModel)]="searchClient" (ngModelChange)="applyFilter()">
      </div>
  ...
  <div class="card">
    @if (loading) {
      ...
      <table class="data-table">
        <thead>
          <tr>
            <th>R\xE9f\xE9rence</th><th>Date</th><th>Client</th>
        ...
        <tfoot>
          <tr>
            <td colspan="6" class="foot-label">TOTAL ENCAISS\xC9</td>
    ...
    <div class="modal-panel" (click)="$event.stopPropagation()">
      ...
      <div class="modal-body">
        <div class="detail-grid">
          ...
          <div class="detail-item">
            <span class="detail-label">\xC9criture comptable</span>
            <span class="detail-value font-mono">{{ selectedPayment.accountMoveName || '\u2014' }}</span>
          </div>
          <div class="detail-item">
...
@if (showNewModal) {
  <div class="modal-overlay" (click)="closeNewPayment()">
    <div class="modal-panel modal-panel-lg" (click)="$event.stopPropagation()">
      ...
      <div class="modal-hdr">
        <div class="modal-title"><span class="material-icons">add_circle</span> Nouveau paiement client</div>
      ...
      <div class="steps-bar">
        <div class="step" [class.step-active]="newPayStep === 1" [class.step-done]="newPayStep > 1">
          <div class="step-dot">1</div><span>Client</span>
        </div>
      ...
      <div class="modal-body">
        ...
        <!-- \xC9tape 1 : Choisir client -->
        @if (newPayStep === 1) {
          @if (loadingInvoices) {
            <div class="step-loading"><span class="material-icons spin">refresh</span> Chargement des factures\u2026</div>
          } @else if (unpaidClients.length === 0) {
            <div class="step-empty"><span class="material-icons">check_circle</span><p>Aucune facture impay\xE9e.</p></div>
          } @else {
            <p class="step-hint">S\xE9lectionnez le client \xE0 encaisser :</p>
            <div class="supplier-grid">
              @for (c of unpaidClients; track c.id) {
                <div class="supplier-card" (click)="selectClient(c.id)">
                  <div class="supplier-avatar">{{ c.name[0] }}</div>
                  <div class="supplier-info">
                    <div class="supplier-name">{{ c.name }}</div>
                    <div class="supplier-count">{{ c.invoiceCount }} facture(s) impay\xE9e(s)</div>
                  </div>
        ...
        @if (newPayStep === 2) {
          <div class="step-back">
            ...
            <span class="step-context">{{ clientName(selectedClientId) }}</span>
          </div>
          <p class="step-hint">S\xE9lectionnez la facture \xE0 r\xE9gler :</p>
          <div class="invoice-list-select">
            @for (inv of invoicesForClient; track inv.id) {
        ...
        @if (newPayStep === 3 && selectedInvoice) {
          ...
          <div class="inv-recap">
            <div class="inv-recap-row">
              <span>Client</span><strong>{{ selectedInvoice.partnerName }}</strong>
            </div>
            <div class="inv-recap-row">
              <span>Facture</span><strong>{{ selectedInvoice.name }}</strong>
            </div>
            <div class="inv-recap-row">
              <span>Reste \xE0 encaisser</span>
