...
var salesRoutes = [
  {
    ...
    children: [
      ...
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-52CMCSNJ.js").then((m) => m.SalesDashboardComponent)
      },
      {
        path: "orders",
        loadComponent: () => import("./chunk-VPE3VH26.js").then((m) => m.OrderListComponent)
      },
      {
        path: "orders/new",
        loadComponent: () => import("./chunk-IW3NX56Q.js").then((m) => m.OrderFormComponent)
      },
      {
        path: "orders/:id",
        loadComponent: () => import("./chunk-IW3NX56Q.js").then((m) => m.OrderFormComponent)
      ...
      {
        path: "invoices",
        loadComponent: () => import("./chunk-UHL6A3S7.js").then((m) => m.InvoiceListComponent)
      },
      {
        path: "invoices/:id",
        loadComponent: () => import("./chunk-VLWD4XSQ.js").then((m) => m.InvoiceDetailComponent)
      },
      {
        path: "avoirs",
        loadComponent: () => import("./chunk-AVSVKVQX.js").then((m) => m.AvoirListComponent)
      },
      {
        path: "payments",
      ...
      {
        path: "clients",
        loadComponent: () => import("./chunk-YUGLZGR4.js").then((m) => m.ClientListComponent)
      },
      {
        path: "clients/prix",
        loadComponent: () => import("./chunk-VMEARH5Y.js").then((m) => m.ClientPriceComponent)
      },
      {
        path: "vendeurs",
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-52FTWY4B.js").then((m) => m.StatsVentesComponent)
      },
      {
      ...
      {
        path: "ristournes",
        loadComponent: () => import("./chunk-KXNBFZDA.js").then((m) => m.RistourneListComponent)
      },
      {
        path: "precomptes",
        loadComponent: () => import("./chunk-JFUU2FQB.js").then((m) => m.PrecompteConfigComponent)
      },
      {
        path: "eleader/import",
...
//# sourceMappingURL=chunk-3MR57KPC.js.map
