...
// src/app/modules/sales/components/reports/rapport-ristourne/rapport-ristourne.component.ts
var ExcelJS = __toESM(require_exceljs_min());
var _forTrack0 = ($index, $item) => $item.partnerName;
var _forTrack1 = ($index, $item) => $item.categoryName + $item.typeRistourne;
function RapportRistourneComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 5)(1, "button", 17);
    \u0275\u0275listener("click", function RapportRistourneComponent_Conditional_7_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275listener("click", function RapportRistourneComponent_Conditional_7_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
function RapportRistourneComponent_Conditional_37_Template(rf, ctx) {
  if (rf & 1) {
...
function RapportRistourneComponent_Conditional_38_Template(rf, ctx) {
  if (rf & 1) {
...
function RapportRistourneComponent_Conditional_39_Template(rf, ctx) {
  if (rf & 1) {
...
function RapportRistourneComponent_Conditional_40_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 20)(1, "span", 4);
    \u0275\u0275text(2, "search_off");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p");
    \u0275\u0275text(4, "Aucune ristourne enregistr\xE9e sur cette p\xE9riode.");
    \u0275\u0275elementEnd()();
  }
}
function RapportRistourneComponent_Conditional_40_Conditional_1_For_62_Conditional_15_Conditional_1_For_17_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275classProp("badge-brasserie", l_r6.typeRistourne === "brasserie")("badge-guinness", l_r6.typeRistourne === "guinness");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", l_r6.typeRistourne || "\u2014", " ");
    \u0275\u0275advance(2);
...
function RapportRistourneComponent_Conditional_40_Conditional_1_For_62_Conditional_15_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(14, "Montant TTC (FCFA)");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(15, "tbody");
    \u0275\u0275repeaterCreate(16, RapportRistourneComponent_Conditional_40_Conditional_1_For_62_Conditional_15_Conditional_1_For_17_Template, 17, 19, "tr", null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
...
function RapportRistourneComponent_Conditional_40_Conditional_1_For_62_Conditional_15_Conditional_2_For_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "span", 57);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275classProp("badge-brasserie", l_r7.typeRistourne === "brasserie")("badge-guinness", l_r7.typeRistourne === "guinness");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", l_r7.typeRistourne || "\u2014", " ");
    \u0275\u0275advance(2);
...
function RapportRistourneComponent_Conditional_40_Conditional_1_For_62_Conditional_15_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "table", 50)(1, "thead")(2, "tr")(3, "th", 51);
    \u0275\u0275text(4, "Type");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(10, RapportRistourneComponent_Conditional_40_Conditional_1_For_62_Conditional_15_Conditional_2_For_11_Template, 9, 10, "tr", null, _forTrack1);
    \u0275\u0275elementEnd();
...
function RapportRistourneComponent_Conditional_40_Conditional_1_For_62_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 49);
    \u0275\u0275conditionalCreate(1, RapportRistourneComponent_Conditional_40_Conditional_1_For_62_Conditional_15_Conditional_1_Template, 25, 5, "table", 50);
    \u0275\u0275conditionalCreate(2, RapportRistourneComponent_Conditional_40_Conditional_1_For_62_Conditional_15_Conditional_2_Template, 19, 5, "table", 50);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function RapportRistourneComponent_Conditional_40_Conditional_1_For_62_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 40)(1, "div", 41);
    \u0275\u0275listener("click", function RapportRistourneComponent_Conditional_40_Conditional_1_For_62_Template_div_click_1_listener() {
      const block_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.toggleClient(block_r5.partnerName));
    });
    ...
    \u0275\u0275pipe(14, "number");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(15, RapportRistourneComponent_Conditional_40_Conditional_1_For_62_Conditional_15_Template, 3, 2, "div", 49);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", ctx_r1.isExpanded(block_r5.partnerName) ? "expand_less" : "expand_more", " ");
    \u0275\u0275advance(2);
...
function RapportRistourneComponent_Conditional_40_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function RapportRistourneComponent_Conditional_40_Conditional_1_Template_button_click_52_listener() {
      \u0275\u0275restoreView(_r3);
    ...
    \u0275\u0275listener("click", function RapportRistourneComponent_Conditional_40_Conditional_1_Template_button_click_56_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275repeaterCreate(61, RapportRistourneComponent_Conditional_40_Conditional_1_For_62_Template, 16, 11, "div", 36, _forTrack0);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(12);
    \u0275\u0275textInterpolate(ctx_r1.clientCount);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate2(" ", ctx_r1.clientBlocks.length, " client(s) \u2014 d\xE9tail ", ctx_r1.subGroupBy === "articles" ? "par articles" : "par cat\xE9gories", " ");
    \u0275\u0275advance(11);
    \u0275\u0275repeater(ctx_r1.clientBlocks);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("TOTAL G\xC9N\xC9RAL \u2014 ", ctx_r1.clientBlocks.length, " client(s)");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind2(68, 17, ctx_r1.grandTotal, "1.0-0"), " FCFA");
  }
}
function RapportRistourneComponent_Conditional_40_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, RapportRistourneComponent_Conditional_40_Conditional_0_Template, 5, 0, "div", 20)(1, RapportRistourneComponent_Conditional_40_Conditional_1_Template, 69, 20);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var RapportRistourneComponent = class _RapportRistourneComponent {
  ...
  get clientBlocks() {
    ...
    return [...map.entries()].sort((a, b) => a[0].localeCompare(b[0])).map(([name, { paiements }]) => {
      ...
      for (const al of articleLines) {
        ...
        if (!catMap.has(key))
          catMap.set(key, { categoryName: al.categoryName, typeRistourne: al.typeRistourne, totalAmount: 0 });
        catMap.get(key).totalAmount += al.montantTotal;
      }
      const categoryLines = [...catMap.values()].sort((a, b) => a.typeRistourne.localeCompare(b.typeRistourne) || a.categoryName.localeCompare(b.categoryName));
  ...
  isExpanded(name) {
    return this.expandedClients.has(name);
  }
  expandAll() {
    this.clientBlocks.forEach((b) => this.expandedClients.add(b.partnerName));
  }
  collapseAll() {
  ...
  sumByType(type) {
    ...
    for (const p of this.paiements.filter((x) => x.typeRistourne === type))
      for (const l of p.lines || [])
        t += l.montantTTC ?? l.montantTotal ?? 0;
    return t;
  }
  get totalBrasserie() {
  ...
  get grandTotal() {
    return this.clientBlocks.reduce((s, b) => s + b.total, 0);
  }
  get clientCount() {
  ...
  exportPdf() {
    ...
    y += 7;
    const modeLabel = byArticles ? "PAR ARTICLES" : "PAR CAT\xC9GORIES";
    doc.setFontSize(11);
    doc.setFont("helvetica", "bold");
    doc.setTextColor(17, 24, 39);
    doc.text(`\xC9TAT GLOBAL DES RISTOURNES \u2014 PAR CLIENT / ${modeLabel}`, M, y);
    y += 5;
    doc.setFontSize(8);
    ...
    for (const block of this.clientBlocks) {
      autoTable(doc, {
        ...
        body: [],
        theme: "plain",
        columnStyles: byArticles ? { 0: { cellWidth: 18 }, 1: { cellWidth: 45 }, 2: { cellWidth: 38 }, 3: { cellWidth: 15 }, 4: { cellWidth: 22 }, 5: { cellWidth: 48, halign: "right" } } : { 0: { cellWidth: 20 }, 1: { cellWidth: 100 }, 2: { cellWidth: 66, halign: "right" } }
      });
      y = doc.lastAutoTable.finalY;
      const headRow = byArticles ? ["Type", "Article", "Cat\xE9gorie", "Qt\xE9", "P.U.", "Montant TTC"] : ["Type", "Cat\xE9gorie", "Montant TTC"];
      const bodyRows = byArticles ? block.articleLines.map((l) => [
      ...
      autoTable(doc, {
        ...
        columnStyles: byArticles ? { 0: { cellWidth: 18 }, 1: { cellWidth: 45 }, 2: { cellWidth: 38 }, 3: { cellWidth: 15, halign: "right" }, 4: { cellWidth: 22, halign: "right" }, 5: { cellWidth: 48, halign: "right" } } : { 0: { cellWidth: 20 }, 1: { cellWidth: 100 }, 2: { cellWidth: 66, halign: "right" } }
      });
    ...
    autoTable(doc, {
      ...
      margin: { left: M, right: M },
      body: [[
        { content: "TOTAL G\xC9N\xC9RAL", colSpan: byArticles ? 5 : 2, styles: { fillColor: gray, fontStyle: "bold", halign: "right", textColor: [55, 65, 81] } },
    ...
    for (let i = 1; i <= n; i++) {
      ...
      doc.text(`${this.companyName} \u2014 Logiciel Blessing ERP`, M, 288);
  ...
  exportExcel() {
    return __async(this, null, function* () {
      ...
      t1.value = `${this.companyName} \u2014 \xC9TAT DES RISTOURNES \u2014 ${this.printDateLabel}`;
      ...
      for (const block of this.clientBlocks) {
        ...
        const headers = byArticles ? ["Type", "Article", "Cat\xE9gorie", "Qt\xE9", "P.U.", "Montant (FCFA)"] : ["Type", "Cat\xE9gorie", "Montant (FCFA)"];
        ...
        for (const l of lines) {
          const type = l.typeRistourne ?? l.typeRistourne;
        ...
        subRow.eachCell((c) => {
          ...
          c.font = __spreadProps(__spreadValues({}, c.font || {}), { bold: true, size: 9 });
      ...
      ws.columns = byArticles ? [{ width: 14 }, { width: 30 }, { width: 30 }, { width: 8 }, { width: 12 }, { width: 18 }] : [{ width: 14 }, { width: 40 }, { width: 18 }];
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RapportRistourneComponent, selectors: [["app-rapport-ristourne"]], decls: 41, vars: 11, consts: [[1, "page-container"], [1, "page-header"], [1, "header-left"], [1, "page-title"], [1, "material-icons"], [1, "export-actions"], [1, "filter-card"], [1, "filter-card-title"], [1, "group-section"], [1, "group-label-text"], [1, "group-chips"], [1, "group-chip", 3, "click"], [1, "filter-row"], [1, "filter-group"], ["type", "date", 1, "form-input", 3, "ngModelChange", "ngModel"], [1, "btn-generate", 3, "click", "disabled"], [1, "alert-error"], [1, "btn-export", "btn-excel", 3, "click"], [1, "btn-export", "btn-pdf", 3, "click"], [1, "material-icons", "spin"], [1, "empty-state"], [1, "stats-grid"], [1, "stat-card"], [1, "stat-icon", "stat-total"], [1, "stat-body"], [1, "stat-label"], [1, "stat-value"], [1, "stat-cur"], [1, "stat-icon", "stat-brasserie"], [1, "stat-icon", "stat-guinness"], [1, "stat-icon", "stat-partners"], [1, "acc-toolbar"], [1, "acc-info"], [1, "acc-btns"], [1, "btn-acc", 3, "click"], [1, "groups-list"], [1, "group-block", 3, "is-open"], [1, "grand-total"], [1, "gt-label"], [1, "gt-value"], [1, "group-block"], [1, "group-header", 3, "click"], [1, "group-header-left"], [1, "material-icons", "group-chevron"], [1, "client-avatar"], [1, "group-name"], [1, "group-lines-count"], [1, "group-header-right"], [1, "group-total-chip"], [1, "group-body"], [1, "lines-table"], [1, "col-type"], [1, "col-num", "r"], [1, "col-amount", "r"], [1, "sub-total-row"], ["colspan", "5", 1, "sub-total-label"], [1, "r", "font-mono", "font-bold"], [1, "badge-type"], [1, "label-cell"], [1, "text-muted"], [1, "r", "font-mono"], ["colspan", "2", 1, "sub-total-label"]], template: function RapportRistourneComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(16, "layers");
        \u0275\u0275elementEnd();
        \u0275\u0275text(17, " D\xE9tail sous chaque client ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(18, "div", 10)(19, "button", 11);
        \u0275\u0275listener("click", function RapportRistourneComponent_Template_button_click_19_listener() {
        ...
        \u0275\u0275listener("click", function RapportRistourneComponent_Template_button_click_23_listener() {
        ...
        \u0275\u0275twoWayListener("ngModelChange", function RapportRistourneComponent_Template_input_ngModelChange_31_listener($event) {
        ...
        \u0275\u0275twoWayListener("ngModelChange", function RapportRistourneComponent_Template_input_ngModelChange_35_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.dateTo, $event) || (ctx.dateTo = $event);
          return $event;
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(36, "button", 15);
        \u0275\u0275listener("click", function RapportRistourneComponent_Template_button_click_36_listener() {
          return ctx.generate();
        });
        \u0275\u0275conditionalCreate(37, RapportRistourneComponent_Conditional_37_Template, 3, 0)(38, RapportRistourneComponent_Conditional_38_Template, 3, 0);
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(39, RapportRistourneComponent_Conditional_39_Template, 4, 1, "div", 16);
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(40, RapportRistourneComponent_Conditional_40_Template, 2, 1);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(7);
...
(() => {
  ...
  <div class="page-header">
    <div class="header-left">
      <h1 class="page-title">
        ...
        \xC9tat global des ristournes clients
      </h1>
    </div>
  ...
  <div class="filter-card">
    ...
    <!-- Mode d\xE9tail sous chaque client -->
    <div class="group-section">
      <span class="group-label-text">
        <span class="material-icons">layers</span> D\xE9tail sous chaque client
      </span>
      <div class="group-chips">
        <button class="group-chip" [class.active]="subGroupBy === 'articles'"
                (click)="setSubGroup('articles')">
          <span class="material-icons">inventory_2</span> Par articles
        </button>
        <button class="group-chip" [class.active]="subGroupBy === 'categories'"
                (click)="setSubGroup('categories')">
  ...
  @if (generated) {
    ...
    @if (paiements.length === 0) {
      <div class="empty-state">
        ...
        <p>Aucune ristourne enregistr\xE9e sur cette p\xE9riode.</p>
      </div>
      ...
      <div class="stats-grid">
        <div class="stat-card">
          <div class="stat-icon stat-total"><span class="material-icons">redeem</span></div>
          <div class="stat-body">
            <div class="stat-label">Total ristournes</div>
        ...
        <div class="stat-card">
          <div class="stat-icon stat-partners"><span class="material-icons">people</span></div>
          <div class="stat-body">
      ...
      <div class="acc-toolbar">
        <span class="acc-info">
          ...
          {{ clientBlocks.length }} client(s) \u2014
          d\xE9tail {{ subGroupBy === 'articles' ? 'par articles' : 'par cat\xE9gories' }}
        </span>
        <div class="acc-btns">
      ...
      <div class="groups-list">
        @for (block of clientBlocks; track block.partnerName) {
          <div class="group-block" [class.is-open]="isExpanded(block.partnerName)">

            <!-- En-t\xEAte client -->
            <div class="group-header" (click)="toggleClient(block.partnerName)">
              <div class="group-header-left">
                <span class="material-icons group-chevron">
                  {{ isExpanded(block.partnerName) ? 'expand_less' : 'expand_more' }}
                </span>
              ...
              <div class="group-body">
                  ...
                  <table class="lines-table">
                    <thead>
                      <tr>
                        ...
                        <th class="col-amount r">Montant TTC (FCFA)</th>
                      </tr>
                    </thead>
                    <tbody>
                      @for (l of block.articleLines; track $index) {
                        <tr>
                          <td>
                            <span class="badge-type" [class.badge-brasserie]="l.typeRistourne === 'brasserie'"
                                                     [class.badge-guinness]="l.typeRistourne === 'guinness'">
                              {{ l.typeRistourne || '\u2014' }}
                            </span>
                          </td>
                ...
                @if (subGroupBy === 'categories') {
                  <table class="lines-table">
                    ...
                    <tbody>
                      @for (l of block.categoryLines; track l.categoryName + l.typeRistourne) {
                        <tr>
                          <td>
                            <span class="badge-type" [class.badge-brasserie]="l.typeRistourne === 'brasserie'"
                                                     [class.badge-guinness]="l.typeRistourne === 'guinness'">
        ...
        <div class="grand-total">
          <span class="gt-label">TOTAL G\xC9N\xC9RAL \u2014 {{ clientBlocks.length }} client(s)</span>
