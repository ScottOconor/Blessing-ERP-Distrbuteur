...
// src/app/modules/stock/components/units-of-measure/unit-of-measure-list.component.ts
var _c0 = ["importInput"];
var _forTrack0 = ($index, $item) => $item.id;
function UnitOfMeasureListComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 10);
    \u0275\u0275listener("click", function UnitOfMeasureListComponent_Conditional_7_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275listener("click", function UnitOfMeasureListComponent_Conditional_7_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
function UnitOfMeasureListComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 13);
    \u0275\u0275listener("click", function UnitOfMeasureListComponent_Conditional_8_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(2, "add");
    \u0275\u0275elementEnd();
    \u0275\u0275text(3, " Nouvelle unit\xE9");
    \u0275\u0275elementEnd();
  }
}
function UnitOfMeasureListComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
...
function UnitOfMeasureListComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
...
function UnitOfMeasureListComponent_Conditional_11_For_11_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 21);
    \u0275\u0275listener("click", function UnitOfMeasureListComponent_Conditional_11_For_11_Conditional_7_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r4);
...
function UnitOfMeasureListComponent_Conditional_11_For_11_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 22);
    \u0275\u0275listener("click", function UnitOfMeasureListComponent_Conditional_11_For_11_Conditional_8_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const u_r5 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.deleteUom(u_r5));
    });
    \u0275\u0275elementStart(1, "span", 11);
    \u0275\u0275text(2, "delete");
    \u0275\u0275elementEnd()();
...
function UnitOfMeasureListComponent_Conditional_11_For_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(7, UnitOfMeasureListComponent_Conditional_11_For_11_Conditional_7_Template, 3, 0, "button", 19);
    \u0275\u0275conditionalCreate(8, UnitOfMeasureListComponent_Conditional_11_For_11_Conditional_8_Template, 3, 0, "button", 20);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function UnitOfMeasureListComponent_Conditional_11_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td", 23);
    \u0275\u0275text(2, "Aucune unit\xE9 de mesure \u2014 cr\xE9ez la premi\xE8re");
    \u0275\u0275elementEnd()();
  }
}
function UnitOfMeasureListComponent_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(10, UnitOfMeasureListComponent_Conditional_11_For_11_Template, 9, 4, "tr", null, _forTrack0);
    \u0275\u0275conditionalCreate(12, UnitOfMeasureListComponent_Conditional_11_Conditional_12_Template, 3, 0, "tr");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(10);
    \u0275\u0275repeater(ctx_r1.uoms);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.uoms.length === 0 ? 12 : -1);
  }
}
function UnitOfMeasureListComponent_Conditional_12_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function UnitOfMeasureListComponent_Conditional_12_For_21_Template(rf, ctx) {
  if (rf & 1) {
...
function UnitOfMeasureListComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 24);
    \u0275\u0275listener("click", function UnitOfMeasureListComponent_Conditional_12_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275conditionalCreate(2, UnitOfMeasureListComponent_Conditional_12_Conditional_2_Template, 6, 1, "div", 26);
    \u0275\u0275elementStart(3, "div", 27)(4, "h3");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "button", 28);
    \u0275\u0275listener("click", function UnitOfMeasureListComponent_Conditional_12_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeImportModal());
    });
    ...
    \u0275\u0275repeaterCreate(20, UnitOfMeasureListComponent_Conditional_12_For_21_Template, 7, 3, "tr", null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(22, "div", 30)(23, "button", 31);
    \u0275\u0275listener("click", function UnitOfMeasureListComponent_Conditional_12_Template_button_click_23_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeImportModal());
    });
    ...
    \u0275\u0275listener("click", function UnitOfMeasureListComponent_Conditional_12_Template_button_click_25_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("Aper\xE7u import unit\xE9s de mesure (", ctx_r1.importRows.length, " ligne(s))");
    \u0275\u0275advance(15);
    \u0275\u0275repeater(ctx_r1.importRows);
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate1(" Confirmer (", ctx_r1.importRows.length, " unit\xE9s) ");
  }
}
function UnitOfMeasureListComponent_Conditional_13_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
...
function UnitOfMeasureListComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 24);
    \u0275\u0275listener("click", function UnitOfMeasureListComponent_Conditional_13_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function UnitOfMeasureListComponent_Conditional_13_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.showModal = false);
    });
    ...
    \u0275\u0275conditionalCreate(9, UnitOfMeasureListComponent_Conditional_13_Conditional_9_Template, 4, 1, "div", 39);
    ...
    \u0275\u0275twoWayListener("ngModelChange", function UnitOfMeasureListComponent_Conditional_13_Template_input_ngModelChange_16_listener($event) {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function UnitOfMeasureListComponent_Conditional_13_Template_input_ngModelChange_20_listener($event) {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function UnitOfMeasureListComponent_Conditional_13_Template_button_click_22_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.showModal = false);
    });
    ...
    \u0275\u0275listener("click", function UnitOfMeasureListComponent_Conditional_13_Template_button_click_24_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", ctx_r1.editingId ? "Modifier" : "Nouvelle", " unit\xE9 de mesure");
    \u0275\u0275advance(5);
...
var UOM_HEADERS = ["Nom*", "Code"];
var UOM_SAMPLE = ["Kilogramme", "kg"];
var UnitOfMeasureListComponent = class _UnitOfMeasureListComponent {
  ...
  save() {
    ...
    const obs = this.editingId ? this.stockService.updateUnitOfMeasure(this.editingId, dto) : this.stockService.createUnitOfMeasure(dto);
    obs.subscribe({
      next: () => {
        this.saving = false;
        this.showModal = false;
        this.showSuccess(this.editingId ? "Unit\xE9 mise \xE0 jour" : "Unit\xE9 cr\xE9\xE9e");
        this.load();
      },
      error: (e) => {
        this.saving = false;
  ...
  deleteUom(u) {
    if (!confirm(`Supprimer l'unit\xE9 "${u.name}" ?`))
      return;
    this.stockService.deleteUnitOfMeasure(u.id).subscribe({
      next: () => {
        this.showSuccess("Unit\xE9 supprim\xE9e");
        this.load();
      },
  ...
  confirmImport() {
    return __async(this, null, function* () {
      ...
      for (const row of this.importRows) {
        ...
        try {
          yield this.stockService.createUnitOfMeasure(dto).toPromise();
          done++;
        } catch (e) {
          errors++;
        }
      ...
      this.load();
      this.showSuccess(`Import termin\xE9 : ${done} cr\xE9\xE9e(s), ${errors} erreur(s)`);
    });
  }
  static {
    this.\u0275fac = function UnitOfMeasureListComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _UnitOfMeasureListComponent)(\u0275\u0275directiveInject(StockService), \u0275\u0275directiveInject(AuthService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UnitOfMeasureListComponent, selectors: [["app-unit-of-measure-list"]], viewQuery: function UnitOfMeasureListComponent_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuery(_c0, 5);
      }
      if (rf & 2) {
    ...
    }, decls: 14, vars: 6, consts: [["importInput", ""], [1, "page-container"], ["type", "file", "accept", ".xlsx,.xls", 2, "display", "none", 3, "change"], [1, "page-header"], [1, "page-title"], [2, "display", "flex", "gap", "8px", "align-items", "center"], [1, "btn-primary"], [1, "alert", "alert-success"], [1, "loading-state"], [1, "card"], [1, "btn-outline", 3, "click"], [1, "material-icons"], [1, "btn-import", 3, "click", "disabled"], [1, "btn-primary", 3, "click"], [1, "material-icons", "spin"], [1, "cfg-table"], [1, "code-badge"], [1, "fw-500"], [2, "display", "flex", "gap", "4px"], [1, "btn-icon"], ["title", "Supprimer", 1, "btn-icon", "btn-icon-danger"], [1, "btn-icon", 3, "click"], ["title", "Supprimer", 1, "btn-icon", "btn-icon-danger", 3, "click"], ["colspan", "3", 1, "empty-state"], [1, "modal-backdrop", 3, "click"], [1, "modal", 2, "max-width", "700px", "position", "relative"], [2, "position", "absolute", "inset", "0", "background", "rgba(255,255,255,0.9)", "display", "flex", "flex-direction", "column", "align-items", "center", "justify-content", "center", "z-index", "10", "border-radius", "inherit"], [1, "modal-header"], [1, "btn-close", 3, "click"], [2, "overflow-x", "auto", "max-height", "400px"], [1, "modal-footer"], [1, "btn-cancel", 3, "click"], [1, "spinner"], [2, "margin-top", "14px", "color", "#017E84", "font-weight", "600"], [2, "font-size", "12px", "color", "#6c757d", "margin-top", "4px"], [1, "text-muted"], [2, "font-weight", "600"], [1, "modal"], [1, "modal-body"], [1, "alert", "alert-danger"], [1, "form-grid"], [1, "form-group", "form-full"], [1, "req"], ["type", "text", "placeholder", "Ex: Kilogramme", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "form-group"], ["type", "text", "placeholder", "kg", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "btn-secondary", 3, "click"], [1, "btn-primary", 3, "click", "disabled"]], template: function UnitOfMeasureListComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1)(1, "input", 2, 0);
        \u0275\u0275listener("change", function UnitOfMeasureListComponent_Template_input_change_1_listener($event) {
          return ctx.onImportFileChange($event);
        });
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(3, "div", 3)(4, "h1", 4);
        \u0275\u0275text(5, "Unit\xE9s de mesure");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(6, "div", 5);
        \u0275\u0275conditionalCreate(7, UnitOfMeasureListComponent_Conditional_7_Template, 8, 2);
        \u0275\u0275conditionalCreate(8, UnitOfMeasureListComponent_Conditional_8_Template, 4, 0, "button", 6);
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(9, UnitOfMeasureListComponent_Conditional_9_Template, 4, 1, "div", 7);
        \u0275\u0275conditionalCreate(10, UnitOfMeasureListComponent_Conditional_10_Template, 4, 0, "div", 8)(11, UnitOfMeasureListComponent_Conditional_11_Template, 13, 1, "div", 9);
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(12, UnitOfMeasureListComponent_Conditional_12_Template, 29, 3);
        \u0275\u0275conditionalCreate(13, UnitOfMeasureListComponent_Conditional_13_Template, 28, 6);
      }
      if (rf & 2) {
        \u0275\u0275advance(7);
...
(() => {
  ...
  <div class="page-header">
    ...
    <div style="display:flex;gap:8px;align-items:center">
      ...
      @if (canCreate) {
        <button class="btn-primary" (click)="openNew()"><span class="material-icons">add</span> Nouvelle unit\xE9</button>
      }
    </div>
  </div>
          ...
          @for (u of uoms; track u.id) {
            <tr>
              ...
              <td style="display:flex;gap:4px">
                @if (canEdit) {
                  <button class="btn-icon" (click)="openEdit(u)"><span class="material-icons">edit</span></button>
                }
                @if (canDelete) {
                  <button class="btn-icon btn-icon-danger" (click)="deleteUom(u)" title="Supprimer"><span class="material-icons">delete</span></button>
                }
              </td>
            </tr>
          }
          @if (uoms.length === 0) {
            <tr><td colspan="3" class="empty-state">Aucune unit\xE9 de mesure \u2014 cr\xE9ez la premi\xE8re</td></tr>
          }
        </tbody>
      </table>
    </div>
...
@if (showImportModal) {
  ...
  <div class="modal" style="max-width:700px;position:relative">
    ...
    <div class="modal-header">
      <h3>Aper\xE7u import unit\xE9s de mesure ({{ importRows.length }} ligne(s))</h3>
    ...
    <div class="modal-footer">
      ...
      <button class="btn-primary" (click)="confirmImport()">
        <span class="material-icons">check_circle</span> Confirmer ({{ importRows.length }} unit\xE9s)
      </button>
    </div>
  </div>
}
...
@if (showModal) {
  ...
  <div class="modal">
    <div class="modal-header">
      <h2>{{ editingId ? 'Modifier' : 'Nouvelle' }} unit\xE9 de mesure</h2>
    ...
    <div class="modal-body">
      ...
      <div class="form-grid">
        <div class="form-group form-full">
          ...
          <input type="text" [(ngModel)]="form.name" class="form-control" placeholder="Ex: Kilogramme" />
        </div>
        <div class="form-group">
          <label>Code</label>
          <input type="text" [(ngModel)]="form.code" class="form-control" placeholder="kg" />
        </div>
      </div>
    </div>
    <div class="modal-footer">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UnitOfMeasureListComponent, { className: "UnitOfMeasureListComponent", filePath: "app/modules/stock/components/units-of-measure/unit-of-measure-list.component.ts", lineNumber: 18 });
})();
export {
  UnitOfMeasureListComponent
};
//# sourceMappingURL=chunk-TVFLOBTC.js.map
