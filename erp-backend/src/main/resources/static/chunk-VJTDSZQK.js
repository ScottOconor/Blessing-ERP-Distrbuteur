...
var StockService = class _StockService {
  ...
  uploadProductPhoto(id, file) {
    ...
    return this.http.post(`${this.api}/products/${id}/photo`, form);
  }
  deleteProductPhoto(id) {
    return this.http.delete(`${this.api}/products/${id}/photo`);
  }
  getProductPhotoUrl(id) {
...
//# sourceMappingURL=chunk-VJTDSZQK.js.map
