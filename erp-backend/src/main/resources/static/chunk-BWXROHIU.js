...
var caissesRoutes = [
  {
    ...
    children: [
      ...
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-S3MHPXMV.js").then((m) => m.CaisseDashboardComponent)
      },
      {
        path: "gestion",
        loadComponent: () => import("./chunk-6CWLLVYU.js").then((m) => m.CaisseListComponent)
      },
      {
        path: "entrees/new",
        loadComponent: () => import("./chunk-LICOWAWR.js").then((m) => m.OperationFormComponent)
      },
      {
        path: "entrees",
        loadComponent: () => import("./chunk-2WFKDNNM.js").then((m) => m.OperationListComponent)
      },
      {
        path: "sorties/new",
        loadComponent: () => import("./chunk-LICOWAWR.js").then((m) => m.OperationFormComponent)
      ...
      {
        path: "brouillard",
        loadComponent: () => import("./chunk-LBEBNK3R.js").then((m) => m.BrouillardComponent)
      },
      {
        path: "suivi-tiers",
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-D2M7BBW7.js").then((m) => m.RapportClotureComponent)
      },
      {
        path: "rapport-consolide",
        loadComponent: () => import("./chunk-T5VDWVZW.js").then((m) => m.RapportConsolideComponent)
      },
      {
        path: "coupures",
        loadComponent: () => import("./chunk-ROPGFXNJ.js").then((m) => m.DenominationsComponent)
      }
    ]
  }
];
...
//# sourceMappingURL=chunk-BWXROHIU.js.map
