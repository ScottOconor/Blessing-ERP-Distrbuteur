...
var caissesRoutes = [
  {
    ...
    children: [
      ...
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-UMAXKOW3.js").then((m) => m.CaisseDashboardComponent)
      },
      {
        path: "gestion",
        loadComponent: () => import("./chunk-OCOTIBHA.js").then((m) => m.CaisseListComponent)
      },
      {
        path: "entrees/new",
        loadComponent: () => import("./chunk-GP5EKSHR.js").then((m) => m.OperationFormComponent)
      },
      {
        path: "entrees",
        loadComponent: () => import("./chunk-JM2RNZ5L.js").then((m) => m.OperationListComponent)
      },
      {
        path: "sorties/new",
        loadComponent: () => import("./chunk-GP5EKSHR.js").then((m) => m.OperationFormComponent)
      ...
      {
        path: "brouillard",
        loadComponent: () => import("./chunk-SYCNZYTR.js").then((m) => m.BrouillardComponent)
      },
      {
        path: "suivi-tiers",
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-VZZPXFJX.js").then((m) => m.RapportClotureComponent)
      },
      {
        path: "rapport-consolide",
        loadComponent: () => import("./chunk-5SKG2NEA.js").then((m) => m.RapportConsolideComponent)
      },
      {
        path: "coupures",
        loadComponent: () => import("./chunk-GB55E4SD.js").then((m) => m.DenominationsComponent)
      }
    ]
  }
];
...
//# sourceMappingURL=chunk-RFEE7IUK.js.map
