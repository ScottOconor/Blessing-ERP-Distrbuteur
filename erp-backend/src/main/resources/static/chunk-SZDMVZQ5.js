...
var purchasesRoutes = [
  {
    ...
    children: [
      ...
      { path: "orders/new", loadComponent: () => import("./chunk-6G3YE7LQ.js").then((m) => m.OrderFormComponent) },
      { path: "orders/:id", loadComponent: () => import("./chunk-6G3YE7LQ.js").then((m) => m.OrderFormComponent) },
      { path: "suppliers", loadComponent: () => import("./chunk-ZECYZLKV.js").then((m) => m.SupplierListComponent) },
      { path: "tarifs-fournisseurs", loadComponent: () => import("./chunk-RYUYY6MB.js").then((m) => m.FournisseurPriceComponent) },
      { path: "invoices", loadComponent: () => import("./chunk-25VZ6GFW.js").then((m) => m.PurchaseInvoiceListComponent) },
      { path: "invoices/:id", loadComponent: () => import("./chunk-G2AUL5QA.js").then((m) => m.PurchaseInvoiceDetailComponent) },
      { path: "avoirs", loadComponent: () => import("./chunk-XTKA6AIM.js").then((m) => m.PurchaseAvoirListComponent) },
      { path: "remises", loadComponent: () => import("./chunk-54C6U5YH.js").then((m) => m.RemiseListComponent) },
      { path: "payments", loadComponent: () => import("./chunk-JCIZBVUF.js").then((m) => m.PaymentListComponent) },
      { path: "enlevements", loadComponent: () => import("./chunk-S2USJCUR.js").then((m) => m.EnlevementListComponent) },
      { path: "rapports", loadComponent: () => import("./chunk-MJUNPGJF.js").then((m) => m.RapportRemiseComponent) },
      { path: "rapports-enlevements", loadComponent: () => import("./chunk-EBFUO2QT.js").then((m) => m.RapportEnlevementComponent) },
      { path: "rapports/stats-achats", loadComponent: () => import("./chunk-W4UM4MXH.js").then((m) => m.StatsAchatsComponent) }
    ]
  }
];
export {
...
//# sourceMappingURL=chunk-SZDMVZQ5.js.map
