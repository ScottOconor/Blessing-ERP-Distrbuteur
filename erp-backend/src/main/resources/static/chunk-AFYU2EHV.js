...
var purchasesRoutes = [
  {
    ...
    children: [
      ...
      { path: "orders/new", loadComponent: () => import("./chunk-LLGGMJWL.js").then((m) => m.OrderFormComponent) },
      { path: "orders/:id", loadComponent: () => import("./chunk-LLGGMJWL.js").then((m) => m.OrderFormComponent) },
      { path: "suppliers", loadComponent: () => import("./chunk-YDQMLEIM.js").then((m) => m.SupplierListComponent) },
      { path: "tarifs-fournisseurs", loadComponent: () => import("./chunk-4FMIS7VP.js").then((m) => m.FournisseurPriceComponent) },
      ...
      { path: "avoirs", loadComponent: () => import("./chunk-VMIAW7Y6.js").then((m) => m.PurchaseAvoirListComponent) },
      { path: "remises", loadComponent: () => import("./chunk-IMG5HR6I.js").then((m) => m.RemiseListComponent) },
      { path: "payments", loadComponent: () => import("./chunk-JCIZBVUF.js").then((m) => m.PaymentListComponent) },
      { path: "enlevements", loadComponent: () => import("./chunk-KGTJT3LV.js").then((m) => m.EnlevementListComponent) },
      ...
      { path: "rapports/stats-achats", loadComponent: () => import("./chunk-6KOIKYPU.js").then((m) => m.StatsAchatsComponent) }
    ]
  }
];
export {
...
//# sourceMappingURL=chunk-AFYU2EHV.js.map
