...
var stockRoutes = [
  {
    ...
    children: [
      ...
      { path: "receptions/new", loadComponent: () => import("./chunk-P3Q2S7A7.js").then((m) => m.ReceptionDetailComponent) },
      { path: "receptions/bordereau/:id", loadComponent: () => import("./chunk-7TMLKWT3.js").then((m) => m.BordereauComponent) },
      { path: "receptions/:id", loadComponent: () => import("./chunk-P3Q2S7A7.js").then((m) => m.ReceptionDetailComponent) },
      { path: "products", loadComponent: () => import("./chunk-QM6ET4OB.js").then((m) => m.ProductListComponent) },
      ...
      { path: "casses", loadComponent: () => import("./chunk-RJSB3T3E.js").then((m) => m.CasseListComponent) },
      { path: "expeditions", loadComponent: () => import("./chunk-QVXIUMWU.js").then((m) => m.LivraisonListComponent) },
      { path: "expeditions/new", loadComponent: () => import("./chunk-6W6SYWT2.js").then((m) => m.LivraisonDetailComponent) },
      { path: "expeditions/:id", loadComponent: () => import("./chunk-6W6SYWT2.js").then((m) => m.LivraisonDetailComponent) },
      { path: "transferts", loadComponent: () => import("./chunk-HM2IEXCI.js").then((m) => m.TransfertListComponent) },
      { path: "transferts/new", loadComponent: () => import("./chunk-ZNYEXX5N.js").then((m) => m.TransfertDetailComponent) },
      { path: "transferts/:id", loadComponent: () => import("./chunk-ZNYEXX5N.js").then((m) => m.TransfertDetailComponent) },
...
//# sourceMappingURL=chunk-7QLBGANA.js.map
