...
// src/app/modules/helpdesk/layout/helpdesk-layout.component.ts
var _forTrack0 = ($index, $item) => $item.route;
function HelpdeskLayoutComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 3);
  }
  if (rf & 2) {
...
function HelpdeskLayoutComponent_For_18_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 20);
    \u0275\u0275listener("click", function HelpdeskLayoutComponent_For_18_Template_a_click_0_listener() {
...
function HelpdeskLayoutComponent_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 21);
    \u0275\u0275listener("click", function HelpdeskLayoutComponent_Conditional_31_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext();
...
var HelpdeskLayoutComponent = class _HelpdeskLayoutComponent {
  ...
  buildNavItems() {
    ...
    const items = [];
    if (canView)
      items.push({ label: "Tableau de bord", icon: "dashboard", route: "/helpdesk/dashboard" });
    if (canView && isAdmin)
      items.push({ label: "Tous les tickets", icon: "list_alt", route: "/helpdesk/tickets" });
    if (canView)
      items.push({ label: "Mes tickets", icon: "person_pin", route: "/helpdesk/my-tickets" });
    if (canCreate)
      items.push({ label: "Nouveau ticket", icon: "add_circle", route: "/helpdesk/tickets?new=1" });
    return items;
  }
  isActive(route) {
  ...
  static {
    this.\u0275fac = function HelpdeskLayoutComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _HelpdeskLayoutComponent)(\u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(ThemeService), \u0275\u0275directiveInject(AppBrandingService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HelpdeskLayoutComponent, selectors: [["app-helpdesk-layout"]], decls: 34, vars: 11, consts: [[1, "hd-layout"], [1, "hd-navbar"], [1, "hd-brand", 3, "click"], ["alt", "", 1, "nav-app-logo", 3, "src"], [1, "material-icons"], [1, "brand-icon"], [1, "brand-label"], [1, "nav-divider"], ["type", "button", "aria-label", "Ouvrir le menu", 1, "nav-hamburger", 3, "click"], [1, "nav-mobile-panel"], [1, "hd-nav", "nav-links"], [1, "nav-link", 3, "active"], [1, "hd-user", "nav-right"], [1, "user-badge"], [1, "user-initials"], [1, "user-name"], [1, "btn-theme-toggle", 3, "click", "title"], ["title", "D\xE9connexion", 1, "btn-logout", 3, "click"], [1, "nav-backdrop"], [1, "hd-content"], [1, "nav-link", 3, "click"], [1, "nav-backdrop", 3, "click"]], template: function HelpdeskLayoutComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "nav", 1)(2, "div", 2);
        \u0275\u0275listener("click", function HelpdeskLayoutComponent_Template_div_click_2_listener() {
          return ctx.goHome();
        });
        \u0275\u0275conditionalCreate(3, HelpdeskLayoutComponent_Conditional_3_Template, 1, 1, "img", 3);
        \u0275\u0275elementStart(4, "span", 4);
        \u0275\u0275text(5, "chevron_left");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(6, "div", 5)(7, "span", 4);
        \u0275\u0275text(8, "support_agent");
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275listener("click", function HelpdeskLayoutComponent_Template_button_click_12_listener() {
        ...
        \u0275\u0275repeaterCreate(17, HelpdeskLayoutComponent_For_18_Template, 4, 4, "a", 11, _forTrack0);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275listener("click", function HelpdeskLayoutComponent_Template_button_click_25_listener() {
        ...
        \u0275\u0275listener("click", function HelpdeskLayoutComponent_Template_button_click_28_listener() {
          return ctx.logout();
        });
        \u0275\u0275elementStart(29, "span", 4);
        \u0275\u0275text(30, "logout");
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275conditionalCreate(31, HelpdeskLayoutComponent_Conditional_31_Template, 1, 0, "div", 18);
...
var helpdeskRoutes = [
  {
    ...
    children: [
      ...
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-MT5RJQMR.js").then((m) => m.HelpdeskDashboardComponent)
      },
      {
        path: "tickets",
        loadComponent: () => import("./chunk-PEVOBYAD.js").then((m) => m.TicketListComponent)
      },
      {
        path: "my-tickets",
        loadComponent: () => import("./chunk-PEVOBYAD.js").then((m) => m.TicketListComponent),
      ...
      {
        path: "tickets/:id",
        loadComponent: () => import("./chunk-BSKXJYUC.js").then((m) => m.TicketDetailComponent)
      }
    ]
  }
];
...
//# sourceMappingURL=chunk-LSSZ2YVO.js.map
