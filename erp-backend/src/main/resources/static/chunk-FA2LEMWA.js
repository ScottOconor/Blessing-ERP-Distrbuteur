...
function LoginComponent_Conditional_67_Template(rf, ctx) {
  if (rf & 1) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], decls: 74, vars: 17, consts: [["loginForm", "ngForm"], [1, "login-page"], [1, "login-left"], [1, "login-brand"], [1, "brand-logo"], ["alt", "Logo", 1, "brand-app-logo", 3, "src"], [1, "blessing-login-mark"], [1, "brand-name"], [1, "brand-subtitle"], [1, "modules-preview"], [1, "module-icon"], [1, "material-icons"], [1, "left-footer"], [1, "login-right"], [1, "login-form-container"], [1, "form-header"], [1, "form-logo"], [3, "ngSubmit"], [1, "form-group"], ["for", "username"], ["id", "username", "type", "text", "name", "username", "placeholder", "Entrez votre nom d'utilisateur", "autocomplete", "username", "required", "", 1, "form-control", 3, "ngModelChange", "ngModel"], ["for", "password"], [1, "password-field"], ["id", "password", "name", "password", "placeholder", "Entrez votre mot de passe", "autocomplete", "current-password", "required", "", 1, "form-control", 3, "ngModelChange", "type", "ngModel"], ["type", "button", 1, "toggle-password", 3, "click"], [1, "alert-error"], ["type", "submit", 1, "btn-login", 3, "disabled"], [1, "form-footer"], [1, "spinner-sm"]], template: function LoginComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(9, "Blessing Enterprise Resource Planning");
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275text(35, "Param\xE8tres");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(36, "div", 12)(37, "p");
        \u0275\u0275text(38, "Solution int\xE9gr\xE9e pour la gestion de votre entreprise");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(39, "div", 13)(40, "div", 14)(41, "div", 15)(42, "div", 16)(43, "span", 11);
        \u0275\u0275text(44, "lock");
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(47, "p");
        \u0275\u0275text(48, "Acc\xE9dez \xE0 votre espace de gestion");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(49, "form", 17, 0);
        \u0275\u0275listener("ngSubmit", function LoginComponent_Template_form_ngSubmit_49_listener() {
          return ctx.onSubmit();
        });
        \u0275\u0275elementStart(51, "div", 18)(52, "label", 19)(53, "span", 11);
        \u0275\u0275text(54, "person");
        \u0275\u0275elementEnd();
        \u0275\u0275text(55, " Nom d'utilisateur ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(56, "input", 20);
        \u0275\u0275twoWayListener("ngModelChange", function LoginComponent_Template_input_ngModelChange_56_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.username, $event) || (ctx.username = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(57, "div", 18)(58, "label", 21)(59, "span", 11);
        \u0275\u0275text(60, "key");
        \u0275\u0275elementEnd();
        \u0275\u0275text(61, " Mot de passe ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(62, "div", 22)(63, "input", 23);
        ...
        \u0275\u0275listener("click", function LoginComponent_Template_button_click_64_listener() {
          return ctx.togglePassword();
        });
        \u0275\u0275elementStart(65, "span", 11);
        \u0275\u0275text(66);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275conditionalCreate(67, LoginComponent_Conditional_67_Template, 4, 1, "div", 25);
        \u0275\u0275elementStart(68, "button", 26);
        \u0275\u0275conditionalCreate(69, LoginComponent_Conditional_69_Template, 3, 0)(70, LoginComponent_Conditional_70_Template, 2, 0);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(71, "div", 27)(72, "p");
        \u0275\u0275text(73, "K\xB7I\xB7R\xB7A v1.0 \u2014 Kairos Innovation Technologies \u2014 \xA9 2026");
        \u0275\u0275elementEnd()()()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(3);
        ...
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.errorMessage ? 67 : -1);
        \u0275\u0275advance();
    ...
    <div class="login-brand">
      <div class="brand-logo" [class.has-logo]="branding.hasAppLogo">
        @if (branding.hasAppLogo) {
          ...
          <span class="blessing-login-mark">BE</span>
        }
      </div>
      <h1 class="brand-name">{{ branding.appName }}</h1>
      <p class="brand-subtitle">Blessing Enterprise Resource Planning</p>
    </div>
...
//# sourceMappingURL=chunk-FA2LEMWA.js.map
