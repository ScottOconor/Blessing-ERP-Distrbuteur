...
var stockRoutes = [
  {
    ...
    children: [
      ...
      { path: "dashboard", loadComponent: () => import("./chunk-CCOZLVU3.js").then((m) => m.StockDashboardComponent) },
      { path: "receptions", loadComponent: () => import("./chunk-YSV4PCVG.js").then((m) => m.ReceptionListComponent) },
      { path: "receptions/new", loadComponent: () => import("./chunk-KUUWINZI.js").then((m) => m.ReceptionDetailComponent) },
      { path: "receptions/bordereau/:id", loadComponent: () => import("./chunk-LNVHN5OF.js").then((m) => m.BordereauComponent) },
      { path: "receptions/:id", loadComponent: () => import("./chunk-KUUWINZI.js").then((m) => m.ReceptionDetailComponent) },
      { path: "products", loadComponent: () => import("./chunk-F447DSS4.js").then((m) => m.ProductListComponent) },
      { path: "services", loadComponent: () => import("./chunk-F447DSS4.js").then((m) => m.ProductListComponent), data: { serviceMode: true } },
      { path: "warehouses", loadComponent: () => import("./chunk-PR6SFIXU.js").then((m) => m.WarehouseListComponent) },
      { path: "adjustments", loadComponent: () => import("./chunk-ITVECWMY.js").then((m) => m.AdjustmentListComponent) },
      { path: "casses", loadComponent: () => import("./chunk-K2K7AGR2.js").then((m) => m.CasseListComponent) },
      { path: "expeditions", loadComponent: () => import("./chunk-XQUYL3TG.js").then((m) => m.LivraisonListComponent) },
      { path: "expeditions/new", loadComponent: () => import("./chunk-NE6GMEAG.js").then((m) => m.LivraisonDetailComponent) },
      { path: "expeditions/:id", loadComponent: () => import("./chunk-NE6GMEAG.js").then((m) => m.LivraisonDetailComponent) },
      { path: "transferts", loadComponent: () => import("./chunk-ZZG7IZB4.js").then((m) => m.TransfertListComponent) },
      { path: "transferts/new", loadComponent: () => import("./chunk-YS2QZETW.js").then((m) => m.TransfertDetailComponent) },
      { path: "transferts/:id", loadComponent: () => import("./chunk-YS2QZETW.js").then((m) => m.TransfertDetailComponent) },
      { path: "categories", loadComponent: () => import("./chunk-L353H4LI.js").then((m) => m.CategoryListComponent) },
      { path: "units-of-measure", loadComponent: () => import("./chunk-TVFLOBTC.js").then((m) => m.UnitOfMeasureListComponent) },
      { path: "locations", loadComponent: () => import("./chunk-QJTNNRED.js").then((m) => m.LocationListComponent) },
      { path: "picking-types", loadComponent: () => import("./chunk-TBDY3AC6.js").then((m) => m.PickingTypeListComponent) },
      { path: "analyse/rapport", loadComponent: () => import("./chunk-DUYCRYGK.js").then((m) => m.StockReportComponent) },
      { path: "analyse/rapport-stock", loadComponent: () => import("./chunk-RH2XNUDV.js").then((m) => m.StockAnalysisReportComponent) },
      { path: "analyse/mouvements-analyse", loadComponent: () => import("./chunk-T4NGDAGL.js").then((m) => m.MovementAnalysisComponent) },
      { path: "analyse/mouvements", loadComponent: () => import("./chunk-2LVEBKAG.js").then((m) => m.StockMovementsComponent) },
      { path: "analyse/valorisation", loadComponent: () => import("./chunk-VU647OSF.js").then((m) => m.StockValuationComponent) }
    ]
  }
];
export {
...
//# sourceMappingURL=chunk-C4LV3I3I.js.map
