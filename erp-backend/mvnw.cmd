...
if not "%JAVA_HOME%" == "C:\Program Files\Java\jdk-24\bin" goto OkJHome
...
IF NOT EXIST "%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar" (
    ...
    curl -o "%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar" "%DOWNLOAD_URL%"
)

@REM Provide a "standardized" way to retrieve the CLI args that will
@REM temporarily be added to the user agent.
...
@REM Extension to allow automatically downloading the maven-wrapper.jar from Maven-central
@REM This allows using the maven wrapper in projects that prohibit checking in binary data.
@REM Temporarily enable jdk.http.auth.tunneling.disabledSchemes for downloading
@IF EXIST "%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar" (
    ...
    IF NOT "%MVNW_USERNAME%" == "" (
        curl --user %MVNW_USERNAME%:%MVNW_PASSWORD% -o "%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar" "%DOWNLOAD_URL%"
    ) ELSE (
        curl -o "%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar" "%DOWNLOAD_URL%"
    )
)
