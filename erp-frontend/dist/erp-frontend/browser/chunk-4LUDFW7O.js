...
function PurchaseInvoiceListComponent_For_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275domListener("click", function PurchaseInvoiceListComponent_For_11_Template_button_click_0_listener() {
...
function PurchaseInvoiceListComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
...
function PurchaseInvoiceListComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
...
function PurchaseInvoiceListComponent_Conditional_15_For_25_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(inv_r5.purchaseOrderName);
  }
}
function PurchaseInvoiceListComponent_Conditional_15_For_25_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
...
function PurchaseInvoiceListComponent_Conditional_15_For_25_Conditional_24_Template(rf, ctx) {
  if (rf & 1) {
...
function PurchaseInvoiceListComponent_Conditional_15_For_25_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275domElementStart(0, "tr", 16);
    \u0275\u0275domListener("click", function PurchaseInvoiceListComponent_Conditional_15_For_25_Template_tr_click_0_listener() {
    ...
    \u0275\u0275conditionalCreate(9, PurchaseInvoiceListComponent_Conditional_15_For_25_Conditional_9_Template, 2, 1, "span", 18)(10, PurchaseInvoiceListComponent_Conditional_15_For_25_Conditional_10_Template, 2, 0, "span", 19);
    \u0275\u0275domElementEnd();
    ...
    \u0275\u0275conditionalCreate(24, PurchaseInvoiceListComponent_Conditional_15_For_25_Conditional_24_Template, 4, 3);
    \u0275\u0275domElementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(inv_r5.purchaseOrderName ? 9 : 10);
    \u0275\u0275advance(3);
...
function PurchaseInvoiceListComponent_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(24, PurchaseInvoiceListComponent_Conditional_15_For_25_Template, 28, 29, "tr", 15, _forTrack1);
    \u0275\u0275domElementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
var PurchaseInvoiceListComponent = class _PurchaseInvoiceListComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PurchaseInvoiceListComponent, selectors: [["app-purchase-invoice-list"]], decls: 16, vars: 2, consts: [[1, "page-container"], [1, "page-header"], [1, "header-left"], [1, "page-title"], [1, "material-icons"], [1, "record-count"], [1, "filter-bar"], [1, "filter-btn", 3, "active"], [1, "card"], [1, "loading-state"], [1, "empty-state"], [1, "data-table"], [1, "filter-btn", 3, "click"], [1, "material-icons", "spin"], [1, "text-right"], [1, "clickable-row"], [1, "clickable-row", 3, "click"], [1, "font-mono", "font-bold"], [1, "link-ref"], [1, "text-muted"], [1, "text-right", "font-bold"], [1, "text-right", "text-success"], [1, "progress-bar"], [1, "progress-fill"], [1, "progress-pct"]], template: function PurchaseInvoiceListComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275conditionalCreate(13, PurchaseInvoiceListComponent_Conditional_13_Template, 4, 0, "div", 9)(14, PurchaseInvoiceListComponent_Conditional_14_Template, 5, 0, "div", 10)(15, PurchaseInvoiceListComponent_Conditional_15_Template, 26, 0, "table", 11);
        \u0275\u0275domElementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance(8);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(PurchaseInvoiceListComponent, [{
    type: Component,
    args: [{ selector: "app-purchase-invoice-list", standalone: true, imports: [CommonModule], template: `<div class="page-container">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PurchaseInvoiceListComponent, { className: "PurchaseInvoiceListComponent", filePath: "src/app/modules/purchases/components/invoices/invoice-list.component.ts", lineNumber: 14 });
})();
export {
  PurchaseInvoiceListComponent
};
//# sourceMappingURL=chunk-4LUDFW7O.js.map
