...
var routes = [
  ...
  {
    path: "login",
    loadComponent: () => import("./chunk-LJZZGFK4.js").then((m) => m.LoginComponent)
  },
  {
    path: "welcome",
    loadComponent: () => import("./chunk-FDNNEOHZ.js").then((m) => m.WelcomeComponent),
    canActivate: [authGuard]
  },
  {
    path: "accounting",
    loadChildren: () => import("./chunk-2PSOSVKF.js").then((m) => m.accountingRoutes),
    canActivate: [authGuard]
  },
  {
    path: "sales",
    loadChildren: () => import("./chunk-N6NV3XUZ.js").then((m) => m.salesRoutes),
    canActivate: [authGuard]
  },
  {
    path: "purchases",
    loadChildren: () => import("./chunk-A3AX56DW.js").then((m) => m.purchasesRoutes),
    canActivate: [authGuard]
  },
  {
    path: "stock",
    loadChildren: () => import("./chunk-C3ZOA2KZ.js").then((m) => m.stockRoutes),
    canActivate: [authGuard]
  },
...
var AppComponent = class _AppComponent {
  constructor() {
    this.title = "ERP - Syst\xE8me de Gestion";
  }
  static {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppComponent, [{
    type: Component,
    args: [{ selector: "app-root", standalone: true, imports: [RouterOutlet], template: `<router-outlet></router-outlet>`, styles: ["/* angular:styles/component:scss;5fce1d3d3037e05293bf89bd52e79ce90b935edc49d0940bd61a6a5bdcbb13a2;C:/Users/K.I.T/OneDrive/Documents/ERP/erp-frontend/src/app/app.component.ts */\n:host {\n  display: block;\n  height: 100%;\n}\n/*# sourceMappingURL=app.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
