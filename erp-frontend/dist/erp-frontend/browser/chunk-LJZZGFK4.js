...
function LoginComponent_Conditional_72_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23)(1, "span", 5);
...
var LoginComponent = class _LoginComponent {
    ...
    this.authService.login(this.username, this.password).subscribe({
      ...
      error: (err) => {
        ...
        if (err.status === 401) {
          ...
          this.errorMessage = "Impossible de contacter le serveur. V\xE9rifiez votre connexion.";
        } else {
          this.errorMessage = err.error?.message || "Une erreur est survenue. Veuillez r\xE9essayer.";
        }
      }
    });
  }
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], decls: 79, vars: 13, consts: [["loginForm", "ngForm"], [1, "login-page"], [1, "login-left"], [1, "login-brand"], [1, "brand-logo"], [1, "material-icons"], [1, "brand-name"], [1, "brand-subtitle"], [1, "modules-preview"], [1, "module-icon"], [1, "left-footer"], [1, "login-right"], [1, "login-form-container"], [1, "form-header"], [1, "form-logo"], [3, "ngSubmit"], [1, "form-group"], ["for", "username"], ["id", "username", "type", "text", "name", "username", "placeholder", "Entrez votre nom d'utilisateur", "autocomplete", "username", "required", "", 1, "form-control", 3, "ngModelChange", "ngModel"], ["for", "password"], [1, "password-field"], ["id", "password", "name", "password", "placeholder", "Entrez votre mot de passe", "autocomplete", "current-password", "required", "", 1, "form-control", 3, "ngModelChange", "type", "ngModel"], ["type", "button", 1, "toggle-password", 3, "click"], [1, "alert-error"], ["type", "submit", 1, "btn-login", 3, "disabled"], [1, "form-footer"], [1, "spinner-sm"]], template: function LoginComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(7, "ERP Syst\xE8me");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(8, "p", 7);
        \u0275\u0275text(9, "Syst\xE8me de Gestion d'Entreprise");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(10, "div", 8)(11, "div", 9)(12, "span", 5);
        \u0275\u0275text(13, "calculate");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(14, "span");
        \u0275\u0275text(15, "Comptabilit\xE9");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(16, "div", 9)(17, "span", 5);
        \u0275\u0275text(18, "shopping_cart");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(19, "span");
        \u0275\u0275text(20, "Ventes");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(21, "div", 9)(22, "span", 5);
        \u0275\u0275text(23, "local_shipping");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(24, "span");
        \u0275\u0275text(25, "Achats");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(26, "div", 9)(27, "span", 5);
        \u0275\u0275text(28, "inventory_2");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(29, "span");
        \u0275\u0275text(30, "Stock");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(31, "div", 9)(32, "span", 5);
        \u0275\u0275text(33, "people");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(34, "span");
        \u0275\u0275text(35, "Ressources Humaines");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(36, "div", 9)(37, "span", 5);
        \u0275\u0275text(38, "settings");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(39, "span");
        \u0275\u0275text(40, "Param\xE8tres");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(41, "div", 10)(42, "p");
        \u0275\u0275text(43, "Solution int\xE9gr\xE9e pour la gestion de votre entreprise");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(44, "div", 11)(45, "div", 12)(46, "div", 13)(47, "div", 14)(48, "span", 5);
        \u0275\u0275text(49, "lock");
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(62, "div", 16)(63, "label", 19)(64, "span", 5);
        \u0275\u0275text(65, "key");
        \u0275\u0275elementEnd();
        \u0275\u0275text(66, " Mot de passe ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(67, "div", 20)(68, "input", 21);
        ...
        \u0275\u0275text(71);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275conditionalCreate(72, LoginComponent_Conditional_72_Template, 4, 1, "div", 23);
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(76, "div", 25)(77, "p");
        \u0275\u0275text(78, "ERP v1.0 \u2014 \xA9 2026");
        \u0275\u0275elementEnd()()()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(61);
...
(() => {
  ...
  <div class="login-left">
    <div class="login-brand">
      ...
      <h1 class="brand-name">ERP Syst\xE8me</h1>
      <p class="brand-subtitle">Syst\xE8me de Gestion d'Entreprise</p>
    </div>
...
//# sourceMappingURL=chunk-LJZZGFK4.js.map
