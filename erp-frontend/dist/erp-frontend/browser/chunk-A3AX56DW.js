...
function PurchaseLayoutComponent_For_13_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 16);
    \u0275\u0275listener("click", function PurchaseLayoutComponent_For_13_Conditional_0_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r1);
...
function PurchaseLayoutComponent_For_13_Conditional_1_For_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 22);
    \u0275\u0275listener("click", function PurchaseLayoutComponent_For_13_Conditional_1_For_9_Template_button_click_0_listener() {
...
function PurchaseLayoutComponent_For_13_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 17)(1, "button", 18);
    \u0275\u0275listener("click", function PurchaseLayoutComponent_For_13_Conditional_1_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r4);
      const item_r2 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275repeaterCreate(8, PurchaseLayoutComponent_For_13_Conditional_1_For_9_Template, 4, 4, "button", 21, _forTrack1);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const item_r2 = \u0275\u0275nextContext().$implicit;
...
function PurchaseLayoutComponent_For_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, PurchaseLayoutComponent_For_13_Conditional_0_Template, 4, 4, "a", 14);
    \u0275\u0275conditionalCreate(1, PurchaseLayoutComponent_For_13_Conditional_1_Template, 10, 6, "div", 15);
  }
  if (rf & 2) {
...
var PurchaseLayoutComponent = class _PurchaseLayoutComponent {
  ...
  static {
    this.\u0275fac = function PurchaseLayoutComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _PurchaseLayoutComponent)(\u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(Router));
    };
  }
  static {
    ...
    }, decls: 25, vars: 2, consts: [[1, "pur-layout"], [1, "pur-navbar"], [1, "pur-brand", 3, "click"], [1, "material-icons"], [1, "brand-icon"], [1, "brand-label"], [1, "nav-divider"], [1, "pur-nav"], [1, "nav-right"], [1, "user-pill"], [1, "user-avatar-sm"], [1, "user-name-sm"], ["title", "Se d\xE9connecter", 1, "btn-nav-logout", 3, "click"], [1, "pur-content"], [1, "nav-link", 3, "active"], [1, "nav-item-dropdown", 3, "open", "active"], [1, "nav-link", 3, "click"], [1, "nav-item-dropdown"], [1, "nav-link", "dropdown-toggle", 3, "click"], [1, "material-icons", "arrow"], [1, "dropdown-panel"], [1, "dropdown-item", 3, "active"], [1, "dropdown-item", 3, "click"]], template: function PurchaseLayoutComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275repeaterCreate(12, PurchaseLayoutComponent_For_13_Template, 2, 2, null, null, _forTrack0);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275listener("click", function PurchaseLayoutComponent_Template_button_click_20_listener() {
          return ctx.logout();
        });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PurchaseLayoutComponent, { className: "PurchaseLayoutComponent", filePath: "src/app/modules/purchases/layout/purchase-layout.component.ts", lineNumber: 13 });
})();
...
var purchasesRoutes = [
  {
    ...
    children: [
      ...
      { path: "dashboard", loadComponent: () => import("./chunk-3BL3ZDM5.js").then((m) => m.PurchaseDashboardComponent) },
      { path: "orders", loadComponent: () => import("./chunk-ZITSNQT5.js").then((m) => m.OrderListComponent) },
      { path: "orders/new", loadComponent: () => import("./chunk-D6SP6HVH.js").then((m) => m.OrderFormComponent) },
      { path: "orders/:id", loadComponent: () => import("./chunk-D6SP6HVH.js").then((m) => m.OrderFormComponent) },
      { path: "suppliers", loadComponent: () => import("./chunk-ESKGBWXL.js").then((m) => m.SupplierListComponent) },
      { path: "invoices", loadComponent: () => import("./chunk-4LUDFW7O.js").then((m) => m.PurchaseInvoiceListComponent) },
      { path: "invoices/:id", loadComponent: () => import("./chunk-QFTJKZMS.js").then((m) => m.PurchaseInvoiceDetailComponent) },
      { path: "avoirs", loadComponent: () => import("./chunk-BZ3POWKM.js").then((m) => m.PurchaseAvoirListComponent) },
      { path: "remises", loadComponent: () => import("./chunk-TMCUTXQ7.js").then((m) => m.RemiseListComponent) }
    ]
  }
];
export {
...
//# sourceMappingURL=chunk-A3AX56DW.js.map
