...
function LocationListComponent_Conditional_29_For_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "td")(13, "button", 25);
    \u0275\u0275listener("click", function LocationListComponent_Conditional_29_For_17_Template_button_click_13_listener() {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(l_r5.accountCode || "\u2014");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("active", l_r5.active)("inactive", !l_r5.active);
  }
}
function LocationListComponent_Conditional_29_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
...
function LocationListComponent_Conditional_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(16, LocationListComponent_Conditional_29_For_17_Template, 16, 10, "tr", null, _forTrack1);
    \u0275\u0275conditionalCreate(18, LocationListComponent_Conditional_29_Conditional_18_Template, 3, 0, "tr");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.filtered.length === 0 ? 18 : -1);
  }
}
function LocationListComponent_Conditional_30_For_22_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275$index_157_r8 + 1);
    \u0275\u0275advance(2);
...
function LocationListComponent_Conditional_30_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(1, "div", 28)(2, "div", 29)(3, "h2");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 30);
    \u0275\u0275listener("click", function LocationListComponent_Conditional_30_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeImportModal());
    });
    ...
    \u0275\u0275text(7, "close");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(8, "div", 31)(9, "table", 32)(10, "thead")(11, "tr", 33)(12, "th", 34);
    \u0275\u0275text(13, "#");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(21, LocationListComponent_Conditional_30_For_22_Template, 9, 4, "tr", 35, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(23, "div", 36)(24, "button", 37);
    \u0275\u0275listener("click", function LocationListComponent_Conditional_30_Template_button_click_24_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeImportModal());
    });
    ...
    \u0275\u0275listener("click", function LocationListComponent_Conditional_30_Template_button_click_26_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
...
function LocationListComponent_Conditional_31_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 44)(1, "span", 7);
    \u0275\u0275text(2, "error");
    \u0275\u0275elementEnd();
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
...
function LocationListComponent_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(1, "div", 42)(2, "div", 29)(3, "h2");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 30);
    ...
    \u0275\u0275conditionalCreate(9, LocationListComponent_Conditional_31_Conditional_9_Template, 4, 1, "div", 44);
    \u0275\u0275elementStart(10, "div", 45)(11, "div", 46)(12, "label");
    \u0275\u0275text(13, "Nom ");
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "div", 49)(18, "label");
    \u0275\u0275text(19, "Type d'emplacement");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "select", 50);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(31, "div", 49)(32, "label");
    \u0275\u0275text(33, "Compte comptable");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "input", 52);
    \u0275\u0275twoWayListener("ngModelChange", function LocationListComponent_Conditional_31_Template_input_ngModelChange_34_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.form.accountCode, $event) || (ctx_r1.form.accountCode = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(35, "div", 53)(36, "button", 37);
    \u0275\u0275listener("click", function LocationListComponent_Conditional_31_Template_button_click_36_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.showModal = false);
    });
    \u0275\u0275text(37, "Annuler");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "button", 54);
    \u0275\u0275listener("click", function LocationListComponent_Conditional_31_Template_button_click_38_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.form.accountCode);
    \u0275\u0275advance(4);
...
var LocationListComponent = class _LocationListComponent {
  ...
  static {
    ...
    }, decls: 32, vars: 8, consts: [["importInput", ""], [1, "page-container"], ["type", "file", "accept", ".xlsx,.xls", 2, "display", "none", 3, "change"], [1, "page-header"], [1, "page-title"], [2, "display", "flex", "gap", "8px", "align-items", "center"], [1, "btn-outline", 3, "click"], [1, "material-icons"], [1, "btn-import", 3, "click", "disabled"], [1, "btn-primary", 3, "click"], [1, "alert", "alert-success"], [1, "toolbar"], [1, "filter-select", 3, "ngModelChange", "ngModel"], ["value", ""], [3, "value"], [1, "count-info"], [1, "loading-state"], [1, "card"], [1, "material-icons", "spin"], [1, "cfg-table"], [1, "fw-500"], [1, "usage-badge"], [1, "text-muted", "small"], [1, "mono", "text-muted", "small"], [1, "status-dot"], [1, "btn-icon", 3, "click"], ["colspan", "6", 1, "empty-state"], [1, "modal-backdrop", 3, "click"], [1, "modal", 2, "max-width", "650px"], [1, "modal-header"], [1, "btn-close", 3, "click"], [2, "overflow-x", "auto", "max-height", "400px"], [2, "width", "100%", "border-collapse", "collapse", "font-size", "13px"], [2, "background", "#f4f6f8"], [2, "padding", "8px", "border-bottom", "2px solid #e2e8ef", "text-align", "left"], [2, "border-bottom", "1px solid #f0f0f0"], [2, "display", "flex", "justify-content", "flex-end", "gap", "10px", "padding", "16px", "border-top", "1px solid #f0f0f0"], [1, "btn-secondary", 3, "click"], [2, "padding", "7px 8px", "color", "#adb5bd"], [2, "padding", "7px 8px", "font-weight", "600"], [2, "padding", "7px 8px"], [2, "padding", "7px 8px", "color", "#6c757d"], [1, "modal"], [1, "modal-body"], [1, "alert", "alert-danger"], [1, "form-grid"], [1, "form-group", "form-full"], [1, "req"], ["type", "text", "placeholder", "Ex: D\xE9p\xF4t principal", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "form-group"], [1, "form-control", 3, "ngModelChange", "ngModel"], [3, "ngValue"], ["type", "text", "placeholder", "311000", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "modal-footer"], [1, "btn-primary", 3, "click", "disabled"]], template: function LocationListComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(27);
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(28, LocationListComponent_Conditional_28_Template, 4, 0, "div", 16)(29, LocationListComponent_Conditional_29_Template, 19, 1, "div", 17);
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(30, LocationListComponent_Conditional_30_Template, 30, 2);
        \u0275\u0275conditionalCreate(31, LocationListComponent_Conditional_31_Template, 42, 9);
      }
      if (rf & 2) {
        \u0275\u0275advance(11);
        ...
        <tbody>
          @for (l of filtered; track l.id) {
            <tr>
              ...
              <td class="mono text-muted small">{{ l.accountCode || '\u2014' }}</td>
              <td>
                <span class="status-dot" [class.active]="l.active" [class.inactive]="!l.active"></span>
              </td>
              <td><button class="btn-icon" (click)="openEdit(l)"><span class="material-icons">edit</span></button></td>
            </tr>
          }
          @if (filtered.length === 0) {
            <tr><td colspan="6" class="empty-state">Aucun emplacement</td></tr>
          }
        </tbody>
      </table>
    </div>
    ...
    <div class="modal-body">
      ...
      <div class="form-grid">
        ...
        <div class="form-group">
          ...
          <input type="text" [(ngModel)]="form.accountCode" class="form-control" placeholder="311000" />
        </div>
      </div>
    </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LocationListComponent, { className: "LocationListComponent", filePath: "src/app/modules/stock/components/locations/location-list.component.ts", lineNumber: 19 });
})();
export {
  LocationListComponent
};
//# sourceMappingURL=chunk-XLHYNEVH.js.map
